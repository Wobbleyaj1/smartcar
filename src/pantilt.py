...
def PCA9685_setPWMFreq(freq):
    ...
    oldmode = i2c_readReg(PCA9685_ADDRESS, PCA9685_MODE1)
    newmode = (oldmode & 0x7F) | 0x10
    i2c_writeReg(PCA9685_ADDRESS, PCA9685_MODE1, newmode)
    i2c_writeReg(PCA9685_ADDRESS, PCA9685_PRESCALE, prescale)
    i2c_writeReg(PCA9685_ADDRESS, PCA9685_MODE1, oldmode)
    time.sleep(0.005)
    i2c_writeReg(PCA9685_ADDRESS, PCA9685_MODE1, oldmode | 0xA0)
